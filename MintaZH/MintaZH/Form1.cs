...
namespace MintaZH
{
    public partial class Form1 : Form
    {
        ...
        private void Excelbe_ment_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        private void ExcelFeltolt()
        {
            ...
            var filteredResult = from x in results where x.Year == (int)cbEv.SelectedItem orderby x.Position select x;
            int aktsor = 2;
