...
namespace Excel
{
    public partial class Form1 : Form
    {
        ...
        Excelx.Application xlApp;
        Excelx.Workbook xlWB;
        Excelx.Worksheet xlSheet;
        public Form1()
        {
            InitializeComponent();
            LoadData();
        ...
        private void CreateTable()
        {
            ...
            Excelx.Range headerRange = xlSheet.get_Range(GetCell(1, 1), GetCell(1, headers.Length));
            headerRange.Font.Bold = true;
            headerRange.VerticalAlignment = Excelx.XlVAlign.xlVAlignCenter;
            headerRange.HorizontalAlignment = Excelx.XlHAlign.xlHAlignCenter;
